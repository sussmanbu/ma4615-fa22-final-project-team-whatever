...
For our project we added two additional data sets. One contains the mortality rates of children under the age of 5 for each country over the years from 1950 to 2021 and the other contains the income per capita for each country  over the years from 1950 to 2021. Combining these two data sets took quite a bit of work. We first had to design a function that removed the k's from the numerical values representing thousand and then multiplied by 1000 to get a numerical representation of the numbers. From there we used the pivot_longer() and inner_join() functions to combine the data sets for use in our interactive and modeling.  
...
The third data set is population which was found on _____and gives the population of each country _____ (time?)

Finally, we added vaccination rate data for children at 1 year of age ...... 

### Please click [here](/sources) to view our compileed list of sources for our additional data 
### Please click [here](/analysis3) to view the summaries for each variable in the data sets


### Data Overview 

<br> income_mortality (7 Columns, 12567 Rows)
<br> U5Mortality (3 Columns, 13845 Rows)
<br> income_per_capita_ppp (3 Columns, 13845 Rows)
<br> nd (13 Columns, 217 Rows)
<br> pop_size (3 Columns, 13987 Rows)
